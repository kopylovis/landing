...
export const en: Translations = {
  ...
  hero: {
    ...
    lede: {
      ...
      between2: ' and native iOS / Android. Currently shipping ',
      between3: ' and ',
      trailing: '.',
    },
...
export const ru: Translations = {
  ...
  hero: {
    ...
    lede: {
      intro: 'Я —',
      name: 'Ivan Kopylov',
      between1: '. Делаю production-приложения на ',
      strong: 'Kotlin Multiplatform',
      between2: ' и нативных iOS / Android. Сейчас выпускаю ',
      between3: ' и ',
      trailing: '.',
    },
  ...
  apps: {
    eyebrowPrefix: 'Избранные проекты',
    title: 'Приложения, которыми реально пользуются.',
    subtitle:
      'Опубликованы в App Store, Google Play и RuStore. Сделаны от API до пиксельной полировки.',
  },
  ...
  about: {
    eyebrow: 'Обо мне',
    title: 'Инженер с дизайнерским вкусом и продуктовой ответственностью.',
    lede:
      'Делаю мобильные продукты — от архитектуры до магазинов. Десять лет на нативных iOS, Android и Kotlin Multiplatform. И продуктовое чутьё, чтобы закрывать петлю целиком.',
    principles: [
      {
        title: 'Архитектура — это фича',
        body:
          'Чистая архитектура — это часть продукта: тестируемая, предсказуемая, в которую быстро вкатываются. Доменная логика живёт в KMP — независимо от платформы.',
      },
      {
        title: 'Общее по умолчанию, нативное — когда заслужено',
        body:
          'Compose Multiplatform несёт общий UI на iOS, Android и десктоп. Спускаюсь до SwiftUI или нативного Compose там, где конкретный экран этого действительно требует.',
      },
      {
        title: 'Выпускать и измерять',
        body:
          'Оптимизирую время до обратной связи. Непрерывный релиз, аналитика по делу и crash-free стабильность — до того, как вылизывать детали.',
      },
    ],
    stackEyebrow: 'Стек',
    stackTitle: 'Мобильная разработка, целиком.',
    stackSub:
      'Инструменты, на которых выпускаю production-продукты. Выбраны, а не собраны.',
  },

  stack: [
    { name: 'Kotlin Multiplatform', detail: 'Общая бизнес-логика на всех платформах' },
    { name: 'Compose Multiplatform', detail: 'Общий UI поверх KMP — один Compose на iOS, Android и десктоп' },
    { name: 'Android · Kotlin', detail: 'Jetpack Compose, корутины, современный Android' },
    { name: 'iOS · Swift', detail: 'SwiftUI как основа, UIKit — когда оправдан' },
    { name: 'Flutter', detail: 'Когда нужна скорость и единая кодовая база' },
  ],

  footer: {
    eyebrow: 'Связаться',
    title: 'Есть идея, которую стоит сделать?',
    titleBreak: 'Давайте выпустим её вместе.',
    cta: 'Начать разговор',
    channels: {
      email: 'Email',
      github: 'GitHub',
    ...
    copyrightSuffix: ' — сделано с заботой.',
  ...
  projects: {
    authmeister: {
      category: 'Безопасность и аутентификация',
      description:
        'Современный OTP-аутентификатор с поддержкой TOTP и HOTP. Бесшовно переносит аккаунты из других приложений, включая Google Authenticator (через otpauth-migration).',
      features: [
    ...
    sympee: {
      category: 'Подарки и услуги',
      description:
        'Платформа комплиментов: можно удивить друзей услугами и товарами от партнёров. Отправь кофе, стрижку или любой подарок близким в любом городе — по QR-коду.',
      features: [
        'Дарите услуги удалённо',
        'Активация подарков по QR-коду',
    ...
    fastlaneRustore: {
      ...
      description:
        'Fastlane-плагин для автоматической публикации Android-приложений (AAB / APK) в RuStore. Берёт на себя JWE-авторизацию, чистит черновики, загружает сборки и отправляет на модерацию — в одну lane-команду.',
      features: [
        'RSA-SHA512 авторизация и обмен на JWE-токен',
        'Автоочистка незавершённых черновиков',
        'Загрузка AAB или AAB + APK в один шаг',
  ...
  authmeisterPage: {
    ...
    tagline:
      'Современный OTP-аутентификатор, построенный вокруг трёх идей: безопасность по стандартам, простая миграция и ноль данных, покидающих устройство.',
    specs: [
    ...
    featuresTitle: 'Сделан, чтобы раствориться в твоём рабочем потоке.',
    highlights: [
      {
        title: 'TOTP и HOTP — как положено',
        body:
          'Соответствует стандартам: коды по времени и по счётчику. Работает со всем, что поддерживает приложения-аутентификаторы.',
      },
      {
        title: 'Миграция в одно касание',
        body:
          'Сканируешь otpauth-migration QR из Google Authenticator — и все аккаунты на месте. Мгновенно.',
      },
      {
      ...
      },
      {
        ...
        body:
          'Экспортируешь зашифрованное хранилище в любое облако и за секунды восстанавливаешься на новом устройстве.',
      },
    ],
    finalTitle: 'Когда будешь готов.',
    finalBody: 'Доступно в App Store, Google Play и RuStore. Бесплатно, без рекламы и слежки.',
  ...
  notFound: {
    ...
    lede:
      'Не получилось найти страницу, которую вы искали. Возможно, она переехала, была переименована или никогда не существовала.',
    ctaHome: 'На главную',
    ctaReport: 'Сообщить о проблеме',
    hintLabel: 'Возможно, вы искали',
    hints: [
      { label: 'Избранные проекты', to: '/#work', external: false },
    ...
    metaDescription:
      'Страница, которую вы ищете, не существует. Вернитесь на главную, чтобы посмотреть проекты.',
  },
}
